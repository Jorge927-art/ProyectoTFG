...
const Testimonials = () => {
    const testimoniesData = [
        ...
        },
        {
            ...
            testimony: "Los cursos de COLE me han ayudado a mejorar mis habilidades técnicas y a mantenerme actualizado con las últimas tendencias en desarrollo de software.",
        ...
        <section className="py-20 flex flex-col gap-16 px-4">
            ...
            {testimoniesData.map((testimony, index) => (
                <GenericHeader
                    ...
                    align={index % 2 === 0 ? 'left' : 'right'} // Alternamos alineación para variedad visual
